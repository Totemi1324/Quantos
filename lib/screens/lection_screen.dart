...
class LectionScreen extends StatefulWidget {
  static const routeName = "/home/lection";

  const LectionScreen({super.key});

  @override
  State<LectionScreen> createState() => _LectionScreenState();
}

class _LectionScreenState extends State<LectionScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return BlocListener<ContentOutlineService, ContentOutline>(
      ...
      child: BlocBuilder<LessonContentService, LessonContent>(
