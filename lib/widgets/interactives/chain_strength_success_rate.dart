...
class ChainStrengthSuccessRate extends Interactive {
  static const String identifier = "56h_graph_chainstrength";

  ChainStrengthSuccessRate({
  ...
  List<String> _generateSpacedLabels() {
    return List<String>.generate(10, (index) {
      if (index % 2 == 0) return "";
      return ((index + 1) / 10).toStringAsFixed(1);
    });
  }
